package com.xielaoban.aicode.controller;
...
import com.xielaoban.aicode.annotation.AuthCheck;
import com.xielaoban.aicode.common.BaseResponse;
import com.xielaoban.aicode.common.DeleteRequest;
import com.xielaoban.aicode.common.ResultUtils;
...
import com.xielaoban.aicode.domain.dto.app.AppAdminUpdateRequest;
import com.xielaoban.aicode.domain.dto.app.AppQueryRequest;
import com.xielaoban.aicode.domain.dto.app.AppUpdateRequest;
...
public class AppController {
    ...
    public BaseResponse<Boolean> updateApp(@RequestBody AppUpdateRequest appUpdateRequest, HttpServletRequest request) {
        ...
        //4.校验用户是否为应用创建者,仅本人可更新
        ThrowUtils.throwIf(!oldApp.getUserId().equals(loginUser.getId()), ErrorCode.NO_AUTH_ERROR, "仅本人可更新");
        //5.更新应用
        App app = new App();
        app.setId(id);
