...
public class CodeFileSaver {
    ...
    /**
     * 保存 HtmlCodeGenResult
     */
    public static File saveHtmlCodeResult(HtmlCodeGenResult result) {
     ...
     */
    public static File saveMultiFileCodeResult(MultiFileCodeGenResult result) {
